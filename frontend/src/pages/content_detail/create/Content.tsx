...
import { useCreateContentDetail } from "../../../queries/ContentDetailQuery";
...
const CreateContentDetailPage: React.VFC = () => {
	const [state, dispatch] = useReducer(reducer, initialState);
	const queryClient = useQueryClient();

	const createContentDetail = useCreateContentDetail();
	const handleSubmit = () => {
		const postParams = {
			title: state.title,
		...
		createContentDetail.mutate(postParams);
	};

	let errorObject = '';
	if (createContentDetail.isError) {
...
export default CreateContentDetailPage